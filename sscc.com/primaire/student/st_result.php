...
<div class="all_student fix">
	...
	<div class="fix">
	<p style="float:left;margin:0 0 3px 0;width:100%;text-align:center;"><a href="st_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">Voir CGPA et le cours complet</button></a></p>
	</div>
	<?php
	//select semester
		...
		?>
			...
			<p style="float:right;text-align:left;margin:20px 0;width:58%"><a href="st_prof.php"><button class="editbtn">Retour au profil</button></a></p>
