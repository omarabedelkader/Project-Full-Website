...
<div class="all_student fix">
	...
	<div>
	<p style="float:left;margin:0 0 5px 0;width:100%;text-align:center;"><a href="prof_st_result_view_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">Voir CGPA et Cours terminé</button></a></p>
	</div>
	...
	//select semester
		...
		?>
			...
			<p style="float:right;text-align:left;margin:20px 0;width:49%"><a href="prof_st_result.php"><button class="editbtn">Retour à la liste</button></a></p>
