...
<div class="all_student fix">
	...
	<p style='text-align:center;background:#ddd;color:#01C3AA;padding:5px;width:84%;margin:0 auto'>Tous les cours et notes terminés</p>
	<?php
	//select semester
			$i=0;
			$ch = 0;
		...
		?>
			...
			<?php } ?>
			<tr>
			<td><?php echo "Cours Total: <span style='color:#800080;padding:3px 6px;font-size:22px'>".$i."</span>"; ?></td>
				<td colspan="1">Totale CGPA : </td>
				<td colspan="2">
				<?php
				$sg = $gp/$ch;
		...
		<div class="back fix">
			<p style="text-align:center"><a href="heads_st_result.php?vr=<?php echo $stid?>&vn=<?php echo $name?>"><button class="editbtn">Retour à la liste</button></a></p>
		</div>
