...
<div class="all_student fix">
		...
		<div  class="fix" style="background:#ddd;padding:20px;">
			<span style="text-align:center;"><a style="color:#fff;" href="att_view_prof.php"> <button style="background:#58A85D;border:none;color:#fff;padding:10px;">Afficher la participation</button></a></span>
		</div>
		<?php
